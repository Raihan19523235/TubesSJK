...
<body <?php hoot_attr( 'body' ); ?>>
	...
	<a href="#main" class="screen-reader-text"><?php esc_html_e( 'Skip to content', 'hoot-business' ); ?></a>
	...
	<div <?php hoot_attr( 'page-wrapper' ); ?>>
		...
		<div <?php hoot_attr( 'main' ); ?>>
			<?php
			// Template modification Hook
			do_action( 'hootbiz_main_wrapper_start' );