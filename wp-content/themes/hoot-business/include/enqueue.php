...
/* Add custom scripts. */
add_action( 'wp_enqueue_scripts', 'hootbiz_enqueue_scripts', 9 );
...
add_action( 'wp_enqueue_scripts', 'hootbiz_localize_script', 9 );
...
add_action( 'wp_enqueue_scripts', 'hootbiz_base_enqueue_scripts', 11 );
...
add_action( 'wp_enqueue_scripts', 'hootbiz_enqueue_styles', 10 );

/* Dequeue font awesome */
add_action( 'wp_enqueue_scripts', 'hootbiz_dequeue_fontawesome', 99 );
 ...
 * @return void
 */
if ( !function_exists( 'hootbiz_enqueue_scripts' ) ) :
function hootbiz_enqueue_scripts() {
 ...
 * @return void
 */
if ( !function_exists( 'hootbiz_localize_script' ) ) :
function hootbiz_localize_script() {
 ...
 * @return void
 */
if ( !function_exists( 'hootbiz_base_enqueue_scripts' ) ) :
function hootbiz_base_enqueue_scripts() {
 ...
 * @return void
 */
if ( !function_exists( 'hootbiz_enqueue_styles' ) ) :
function hootbiz_enqueue_styles() {

	/* Load Google Fonts if 'google-fonts' is active. */
	$style_uri = hootbiz_google_fonts_enqueue_url();
	if ( $style_uri )
		wp_enqueue_style( 'hootbiz-googlefont', $style_uri, array(), null );
 ...
 * @return void
 */
if ( !function_exists( 'hootbiz_dequeue_fontawesome' ) ) :
function hootbiz_dequeue_fontawesome() {
