...
add_filter( 'hoot_attr_header',   'hootbiz_attr_header',   7, 2 );
add_filter( 'hoot_attr_menu',     'hootbiz_attr_menu',     7, 2 );
add_filter( 'hoot_attr_content',  'hootbiz_attr_content',  7    );
add_filter( 'hoot_attr_sidebar',  'hootbiz_attr_sidebar',  7, 2 );
add_filter( 'hoot_attr_branding', 'hootbiz_attr_branding', 7    );

/* New Theme Filters */
add_filter( 'hoot_attr_page-wrapper',      'hootbiz_attr_page_wrapper',      7    );
add_filter( 'hoot_attr_topbar',            'hootbiz_attr_topbar',            7    );
add_filter( 'hoot_attr_header-part',       'hootbiz_attr_header_part',       7, 2 );
add_filter( 'hoot_attr_header-aside',      'hootbiz_attr_header_aside',      7    );
add_filter( 'hoot_attr_below-header',      'hootbiz_attr_below_header',      7    );
add_filter( 'hoot_attr_main',              'hootbiz_attr_main',              7    );
add_filter( 'hoot_attr_frontpage-grid',    'hootbiz_attr_frontpage_grid',    7    );
add_filter( 'hoot_attr_frontpage-content', 'hootbiz_attr_frontpage_content', 7    );
add_filter( 'hoot_attr_frontpage-area',    'hootbiz_attr_frontpage_area',    7, 2 );
add_filter( 'hoot_attr_loop-meta-wrap',    'hootbiz_attr_loop_meta_wrap',    7, 2 );
add_filter( 'hoot_attr_loop-meta',         'hootbiz_attr_loop_meta',         7, 2 ); // This is a bit more generic (archive / singular etc ) than just for archives
add_filter( 'hoot_attr_loop-title',        'hootbiz_attr_loop_title',        7, 2 ); // This is a bit more generic (archive / singular etc ) than just for archives
add_filter( 'hoot_attr_loop-description',  'hootbiz_attr_loop_description',  7, 2 ); // This is a bit more generic (archive / singular etc ) than just for archives
add_filter( 'hoot_attr_content-wrap',      'hootbiz_attr_content_wrap',      7, 2 );
add_filter( 'hoot_attr_sidebar-wrap',      'hootbiz_attr_sidebar_wrap',      7, 2 );
add_filter( 'hoot_attr_sub-footer',        'hootbiz_attr_sub_footer',        7    );
add_filter( 'hoot_attr_post-footer',       'hootbiz_attr_post_footer',       7    );
 ...
 * @return array
 */
function hootbiz_attr_header( $attr, $context ) {
 ...
 * @return array
 */
function hootbiz_attr_menu( $attr, $context ) {
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
 ...
 * @return array
 */
function hootbiz_attr_content( $attr ) {
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];

	$layout_class = hootbiz_layout_class( 'content' );
 ...
 * @return array
 */
function hootbiz_attr_sidebar( $attr, $context ) {
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
	if ( !empty( $context ) && ( $context == 'primary' || $context == 'secondary' ) ) {
		$layout_class = hootbiz_layout_class( "sidebar" );
		if ( !empty( $layout_class ) )
			$attr['class'] .= $layout_class;
	}
 ...
 * @return array
 */
function hootbiz_attr_branding( $attr ) {
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
 ...
 * @return array
 */
function hootbiz_attr_page_wrapper( $attr ) {
	...
	$classes = apply_filters( 'hootbiz_attr_page_wrapper_plugins', array( 'hoot-cf7-style', 'hoot-mapp-style', 'hoot-jetpack-style' ) );
 ...
 * @return array
 */
function hootbiz_attr_topbar( $attr ) {
	$attr['id'] = 'topbar';
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
	$attr['class'] .= ' topbar';
	return $attr;
 ...
 * @return array
 */
function hootbiz_attr_header_part( $attr, $context ) {
 ...
 * @return array
 */
function hootbiz_attr_header_aside( $attr ) {
 ...
 * @return array
 */
function hootbiz_attr_below_header( $attr ) {
 ...
 * @return array
 */
function hootbiz_attr_main( $attr ) {
	$attr['id'] = 'main';
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
	$attr['class'] .= ' main';
	return $attr;
 ...
 * @return array
 */
function hootbiz_attr_frontpage_grid( $attr ) {
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
 ...
 * @return array
 */
function hootbiz_attr_frontpage_content( $attr ) {
 ...
 * @return array
 */
function hootbiz_attr_frontpage_area( $attr, $context ) {
 ...
 * @return array
 */
function hootbiz_attr_loop_meta_wrap( $attr, $context ) {
 ...
 * @return array
 */
function hootbiz_attr_loop_meta( $attr, $context ) {
 ...
 * @return array
 */
function hootbiz_attr_loop_title( $attr, $context ) {
 ...
 * @return array
 */
function hootbiz_attr_loop_description( $attr, $context ) {
 ...
 * @return array
 */
function hootbiz_attr_content_wrap( $attr, $context ) {
 ...
 * @return array
 */
function hootbiz_attr_sidebar_wrap( $attr, $context ) {
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
 ...
 * @return array
 */
function hootbiz_attr_sub_footer( $attr ) {
	$attr['id'] = 'sub-footer';
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
 ...
 * @return array
 */
function hootbiz_attr_post_footer( $attr ) {
	$attr['id'] = 'post-footer';
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
