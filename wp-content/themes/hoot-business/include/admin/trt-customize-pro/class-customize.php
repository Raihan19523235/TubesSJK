		...
		$manager->add_section(
			new Hoot_Theme_Customize_Section_Pro(
				...
				apply_filters( 'hoot_theme_customize_section_pro', array(
					'title'    => esc_html__( 'Hoot Business Premium', 'hoot-business' ),
					'priority' => 1,
					'pro_text' => esc_html__( 'Premium', 'hoot-business' ),
					'pro_url'  => esc_url( admin_url('themes.php?page=hoot-business-welcome') ),
				) )
			)
		);
	}
