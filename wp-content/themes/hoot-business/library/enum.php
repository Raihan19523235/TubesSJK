...
function hoot_enum_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'hoot-business' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'hoot-business' ),
		'repeat-y'  => __( 'Repeat Vertically', 'hoot-business' ),
		'repeat'    => __( 'Repeat All', 'hoot-business' ),
		);
...
function hoot_enum_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'hoot-business' ),
		'top center'    => __( 'Top Center', 'hoot-business' ),
		'top right'     => __( 'Top Right', 'hoot-business' ),
		'center left'   => __( 'Middle Left', 'hoot-business' ),
		'center center' => __( 'Middle Center', 'hoot-business' ),
		'center right'  => __( 'Middle Right', 'hoot-business' ),
		'bottom left'   => __( 'Bottom Left', 'hoot-business' ),
		'bottom center' => __( 'Bottom Center', 'hoot-business' ),
		'bottom right'  => __( 'Bottom Right', 'hoot-business')
		);
...
function hoot_enum_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'hoot-business' ),
		'fixed'  => __( 'Fixed in Place', 'hoot-business'),
		);
...
function hoot_enum_background_size() {
	$default = array(
		'original' => __( 'Original Size', 'hoot-business' ),
		'contain'  => __( 'Fit to Screen', 'hoot-business'),
		'cover'    => __( 'Fill Screen', 'hoot-business'),
		);
...
function hoot_enum_background_type() {
	$default = array(
		'predefined' => __( 'Predefined Pattern', 'hoot-business' ),
		'custom'     => __( 'Custom Image', 'hoot-business' ),
		);
...
function hoot_enum_font_styles() {
	$default = array(
		'none'                      => __( 'None', 'hoot-business' ),
		'italic'                    => __( 'Italic', 'hoot-business' ),
		'bold'                      => __( 'Bold', 'hoot-business' ),
		'bold italic'               => __( 'Bold Italic', 'hoot-business' ),
		'semibold'                  => __( 'SemiBold', 'hoot-business' ),
		'semibold italic'           => __( 'SemiBold Italic', 'hoot-business' ),
		'lighter'                   => __( 'Light', 'hoot-business' ),
		'lighter italic'            => __( 'Light Italic', 'hoot-business' ),
		'uppercase'                 => __( 'Uppercase', 'hoot-business' ),
		'uppercase italic'          => __( 'Uppercase Italic', 'hoot-business' ),
		'uppercase bold'            => __( 'Uppercase Bold', 'hoot-business' ),
		'uppercase bold italic'     => __( 'Uppercase Bold Italic', 'hoot-business' ),
		'uppercase semibold'        => __( 'Uppercase SemiBold', 'hoot-business' ),
		'uppercase semibold italic' => __( 'Uppercase SemiBold Italic', 'hoot-business' ),
		'uppercase lighter'         => __( 'Uppercase Light', 'hoot-business' ),
		'uppercase lighter italic'  => __( 'Uppercase Light Italic', 'hoot-business' )
		);
...
function hoot_enum_social_profiles( $skype = false, $email = true ) {
	$social = array(
		'fa-amazon'         => __( 'Amazon', 'hoot-business' ),
		'fa-android'        => __( 'Android', 'hoot-business' ),
		'fa-apple'          => __( 'Apple', 'hoot-business' ),
		'fa-bandcamp'       => __( 'Bandcamp', 'hoot-business' ),
		'fa-behance'        => __( 'Behance', 'hoot-business' ),
		'fa-bitbucket'      => __( 'Bitbucket', 'hoot-business' ),
		'fa-btc'            => __( 'BTC', 'hoot-business' ),
		'fa-buysellads'     => __( 'BuySellAds', 'hoot-business' ),
		'fa-codepen'        => __( 'Codepen', 'hoot-business' ),
		'fa-codiepie'       => __( 'Codie Pie', 'hoot-business' ),
		'fa-contao'         => __( 'Contao', 'hoot-business' ),
		'fa-dashcube'       => __( 'Dash Cube', 'hoot-business' ),
		'fa-delicious'      => __( 'Delicious', 'hoot-business' ),
		'fa-deviantart'     => __( 'Deviantart', 'hoot-business' ),
		'fa-digg'           => __( 'Digg', 'hoot-business' ),
		'fa-dribbble'       => __( 'Dribbble', 'hoot-business' ),
		'fa-dropbox'        => __( 'Dropbox', 'hoot-business' ),
		'fa-eercast'        => __( 'Eercast', 'hoot-business' ),
		'fa-envelope'       => __( 'Email', 'hoot-business' ),
		'fa-etsy'           => __( 'Etsy', 'hoot-business' ),
		'fa-facebook'       => __( 'Facebook', 'hoot-business' ),
		'fa-flickr'         => __( 'Flickr', 'hoot-business' ),
		'fa-forumbee'       => __( 'Forumbee', 'hoot-business' ),
		'fa-foursquare'     => __( 'Foursquare', 'hoot-business' ),
		'fa-free-code-camp' => __( 'Free Code Camp', 'hoot-business' ),
		'fa-get-pocket'     => __( 'Pocket (getpocket)', 'hoot-business' ),
		'fa-github'         => __( 'Github', 'hoot-business' ),
		'fa-google'         => __( 'Google', 'hoot-business' ),
		'fa-google-plus'    => __( 'Google Plus', 'hoot-business' ),
		'fa-google-wallet'  => __( 'Google Wallet', 'hoot-business' ),
		'fa-houzz'          => __( 'Houzz', 'hoot-business' ),
		'fa-imdb'           => __( 'IMDB', 'hoot-business' ),
		'fa-instagram'      => __( 'Instagram', 'hoot-business' ),
		'fa-jsfiddle'       => __( 'JS Fiddle', 'hoot-business' ),
		'fa-lastfm'         => __( 'Last FM', 'hoot-business' ),
		'fa-leanpub'        => __( 'Leanpub', 'hoot-business' ),
		'fa-linkedin'       => __( 'Linkedin', 'hoot-business' ),
		'fa-meetup'         => __( 'Meetup', 'hoot-business' ),
		'fa-mixcloud'       => __( 'Mixcloud', 'hoot-business' ),
		'fa-paypal'         => __( 'Paypal', 'hoot-business' ),
		'fa-pinterest'      => __( 'Pinterest', 'hoot-business' ),
		'fa-quora'          => __( 'Quora', 'hoot-business' ),
		'fa-reddit'         => __( 'Reddit', 'hoot-business' ),
		'fa-rss'            => __( 'RSS', 'hoot-business' ),
		'fa-scribd'         => __( 'Scribd', 'hoot-business' ),
		'fa-skype'          => __( 'Skype', 'hoot-business' ),
		'fa-slack'          => __( 'Slack', 'hoot-business' ),
		'fa-slideshare'     => __( 'Slideshare', 'hoot-business' ),
		'fa-snapchat'       => __( 'Snapchat', 'hoot-business' ),
		'fa-soundcloud'     => __( 'Soundcloud', 'hoot-business' ),
		'fa-spotify'        => __( 'Spotify', 'hoot-business' ),
		'fa-stack-exchange' => __( 'Stack Exchange', 'hoot-business' ),
		'fa-stack-overflow' => __( 'Stack Overflow', 'hoot-business' ),
		'fa-steam'          => __( 'Steam', 'hoot-business' ),
		'fa-stumbleupon'    => __( 'Stumbleupon', 'hoot-business' ),
		'fa-trello'         => __( 'Trello', 'hoot-business' ),
		'fa-telegram-plane' => __( 'Telegram', 'hoot-business' ),
		'fa-tripadvisor'    => __( 'Trip Advisor', 'hoot-business' ),
		'fa-tumblr'         => __( 'Tumblr', 'hoot-business' ),
		'fa-twitch'         => __( 'Twitch', 'hoot-business' ),
		'fa-twitter'        => __( 'Twitter', 'hoot-business' ),
		'fa-viadeo'         => __( 'Viadeo', 'hoot-business' ),
		'fa-vimeo-square'   => __( 'Vimeo', 'hoot-business' ),
		'fa-vk'             => __( 'VK', 'hoot-business' ),
		'fa-wikipedia-w'    => __( 'Wikipedia', 'hoot-business' ),
		'fa-windows'        => __( 'Windows', 'hoot-business' ),
		'fa-wordpress'      => __( 'WordPress', 'hoot-business' ),
		'fa-xing'           => __( 'Xing', 'hoot-business' ),
		'fa-y-combinator'   => __( 'Y Combinator', 'hoot-business' ),
		'fa-yelp'           => __( 'Yelp', 'hoot-business' ),
		'fa-youtube'        => __( 'Youtube', 'hoot-business' ),
	);
...
function hoot_fonticons_list( $return = 'icons' ) {
	...
	if ( 'sections' == $return ) :
		return apply_filters( 'hoot_fonticons_sections', array(
			'fonticons' => __('Font Icons', 'hoot-business'),
			'brands'    => __('Brands', 'hoot-business'),
			)
		);
	endif;
