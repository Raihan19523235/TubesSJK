...
<article <?php hoot_attr( 'post', '', 'archive-block archive-block3 hcolumn-1-3' ); ?>>
	...
	<div class="entry-grid hgrid">
		...
		<?php if ( is_sticky() ) : ?>
			<div class="entry-sticky-tag invert-typo"><?php esc_html_e( 'Sticky', 'hoot-business' ) ?></div>
		<?php endif; ?>

		<?php $img_size = apply_filters( 'hootbiz_archive_imgsize', 'hoot-medium-thumb', 'block3' );
