...
hootbiz_add_custom_title_content( 'pre', 'archive-product.php' );
if ( hootbiz_titlearea_top() ) {
	hootbiz_loopmeta_header_img( 'shop', false );
	...
	hootbiz_add_custom_title_content( 'post', 'archive-product.php' );
} else {
	hootbiz_loopmeta_header_img( 'shop', true );
}

// Template modification Hook
do_action( 'hootbiz_before_content_grid', 'archive-product.php' );
?>
...
<div class="hgrid main-content-grid">
	...
	<main <?php hoot_attr( 'content' ); ?>>
		<div <?php hoot_attr( 'content-wrap', 'archive-product' ); ?>>
			...
			<?php
			// Template modification Hook
			do_action( 'hootbiz_main_start', 'archive-product.php' );
			...
			if ( ( function_exists( 'woocommerce_product_loop' ) && woocommerce_product_loop() ) || have_posts() ) :
				...
				// Template modification Hook
				do_action( 'hootbiz_before_loop_nav', 'archive-product.php' );
			...
			// Template modification Hook
			do_action( 'hootbiz_main_end', 'archive-product.php' );
			?>
