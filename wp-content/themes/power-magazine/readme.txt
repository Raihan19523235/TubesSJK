...
Power Magazine WordPress Theme, Copyright (C) 2020, Themes 404
...
JS Files    
    ...
    License:  The MIT License (MIT) Copyright (c) 2017 Ken Wheeler
...
== Changelog ==
= 2.0.1 - September 15 2020 =
* Tested up to 5.5.1
* Fixed Theme Check's issue.
* Added Proper format of license for third party libraries
* Remove unwanted code and unnecessary file and folder.
